	...
	<div class="main-container">
		<div class="pd-ltr-20">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">REJECTED  CRANE APPLICATIONS</h2>
					</div>
				<div class="pb-20">
							...
							<tr>
								...
								<td>
									<div class="table-actions">
										<a title="VIEW" href="request_details.php?leaveid=<?php echo $row['lid'];?>"><i class="dw dw-eye" data-color="#265ed7"></i></a>	
									</div>
								</td>
							</tr>
							<?php }?>
