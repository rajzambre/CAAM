...
<?php
	...
	elseif($leave_days <= 0)
	{
	    echo "<script>alert('YOU HAVE EXCEEDED YOUR REQUEST LIMIT. REQUEST APPLICATION FAILED');</script>";
	  }
		...
		if($lastInsertId)
		{
			echo "<script>alert('Crane Requst was successful.');</script>";
			echo "<script type='text/javascript'> document.location = 'request_history.php'; </script>";
		}
		else 
		{
		...
		<div class="pb-20">
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Crane Request Application</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
									<li class="breadcrumb-item active" aria-current="page">Apply for Crane</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div style="margin-left: 50px; margin-right: 50px;" class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Crane Application Form</h4>
							<p class="mb-20"></p>
						</div>
					</div>
							...
							<section>
								...
								<div class="row">
									<div class="col-md-8 col-sm-12">
										<div class="form-group">
											<label>Reason For Crane Booking Request :</label>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="apply" id="apply" data-toggle="modal">Send&nbsp;Request</button>
											</div>
										</div>
									</div>
								</div>
