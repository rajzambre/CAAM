<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.php">
				<img src="../vendors/images/logo.png" alt="" height="60" width="60" class="dark-logo">
				<img src="../vendors/images/logo.png" alt="" height="60" width="60" class="light-logo">
				<h3 style="color:white">CAAM</h3>
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-apartment"></span><span class="mtext"> Crane Requests </span>
						</a>
						<ul class="submenu">
							<li><a href="apply_request.php">Apply for Crane</a></li>
							<li><a href="request.php">All Requests</a></li>
